...
Currently, asset collection is based on nomenclature specified for MaGMML3 (e.g. sprGannioMySprite), so objects must have a specific username/word after the intial prefix in order to be collected.
